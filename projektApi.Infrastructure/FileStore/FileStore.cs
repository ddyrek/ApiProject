...
namespace projektApi.Infrastructure.FileStore
{
    public class FileStore : IFileStore
    {
        ...
        public FileStore(IFileWrapper fileWrapper, IDirectoryWrapper directoryWrapper) //Konstruktor
        {
        ...
        public string SafeWriteFile(byte[] content, string sourceFileName, string path)
        {
            ...
            var outputFile = Path.Combine(path, sourceFileName); //złaczenie path i sourceFile
