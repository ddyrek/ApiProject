...
namespace projektApi.Persistance.Migrations
{
    ...
    [Migration("20230124184936_SeedClass")]
            ...
            modelBuilder.Entity("projektApi.Domain.Entities.Klient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 24, 19, 49, 35, 662, DateTimeKind.Local).AddTicks(8151),
                            CreatedBy = "Dawid",
                            KontrahentId = 1,
            ...
            modelBuilder.Entity("projektApi.Domain.Entities.Kontrahent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 24, 19, 49, 35, 662, DateTimeKind.Local).AddTicks(7922),
                            CreatedBy = "Dawid",
                            NazwaFirmy = "Top Dogs",
                            StatusId = 1
                        });
            ...
            modelBuilder.Entity("projektApi.Domain.Entities.Wizyta", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataWizyty = new DateTime(2023, 1, 24, 19, 49, 35, 662, DateTimeKind.Local).AddTicks(8389),
                            GodzinaWizyty = new DateTime(2023, 1, 24, 19, 49, 35, 662, DateTimeKind.Local).AddTicks(8394),
                            Kwota = 350m,
                            Opis = "Strzyżenie",
                            PiesId = 1
                        });
